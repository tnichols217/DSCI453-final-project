...
class TBNotInstalledError(Exception):
  def __init__(self, summary_api) -> None:
    ...
  


@tf_export("summary.audio", v1=[])
def audio(name, data, sample_rate, step=..., max_outputs=..., encoding=..., description=...): # -> Any:
...
def histogram(name, data, step=..., buckets=..., description=...): # -> Any:
...
def image(name, data, step=..., max_outputs=..., description=...): # -> Any:
...
def scalar(name, data, step=..., description=...): # -> Any:
...
def text(name, data, step=..., description=...): # -> Any:
