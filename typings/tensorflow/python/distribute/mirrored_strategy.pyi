...
class MirroredStrategy(distribute_lib.Strategy):
  ...
  def __init__(self, devices=..., cross_device_ops=...) -> None:
    ...
...
class MirroredExtended(distribute_lib.StrategyExtendedV1):
  ...
  def __init__(self, container_strategy, devices=..., cross_device_ops=...) -> None:
    ...
  ...
  def value_container(self, val): # -> CompositeTensor | DistributedVariable:
    ...
  
  @property
  def worker_devices(self): # -> tuple[Any | str, ...] | tuple[Any, ...]:
    ...
  ...
  @property
  def parameter_devices(self): # -> tuple[Any | str, ...] | tuple[Any, ...]:
    ...
  ...
  def non_slot_devices(self, var_list): # -> tuple[Any | str, ...] | tuple[Any, ...]:
    ...
