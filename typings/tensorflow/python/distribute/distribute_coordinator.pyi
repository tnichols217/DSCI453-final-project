...
def run_standard_tensorflow_server(session_config=...): # -> Any | _FakeServer | Server:
...
def run_distribute_coordinator(worker_fn, strategy, eval_fn=..., eval_strategy=..., mode=..., cluster_spec=..., task_type=..., task_id=..., session_config=..., rpc_layer=...):
