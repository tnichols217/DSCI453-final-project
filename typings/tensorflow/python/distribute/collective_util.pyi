...
class _OptionsExported:
  ...
  def __init__(self, bytes_per_pack=..., timeout_seconds=..., implementation=...) -> None:
...
class Hints:
  ...
  def __new__(cls, bytes_per_pack=..., timeout_seconds=...): # -> Options:
    ...
  
  def __init__(self, bytes_per_pack=..., timeout_seconds=...) -> None:
    """Creates a CollectiveHints.
