...
def save_model(model, filepath, overwrite=..., include_optimizer=..., save_format=..., signatures=..., options=..., save_traces=...): # -> None:
...
def load_model(filepath, custom_objects=..., compile=..., options=...): # -> Any | AutoTrackable | None:
