...
@dispatch.add_dispatch_support
def swish(x): # -> tuple[Any, Callable[..., tuple[Any, Any]]]:
...
@dispatch.add_dispatch_support
def serialize(activation): # -> str | Any | dict[str, Any] | None:
...
@dispatch.add_dispatch_support
def get(identifier): # -> Callable[..., Any] | Any | Callable[..., object] | None:
  """Returns function.
