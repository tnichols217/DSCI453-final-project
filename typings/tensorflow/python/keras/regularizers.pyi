...
class L1L2(Regularizer):
  ...
  def __call__(self, x): # -> Operation | _EagerTensorBase:
    ...
...
class L1(Regularizer):
  ...
  Attributes:
      l1: Float; L1 regularization factor.
  """
  def __init__(self, l1=..., **kwargs) -> None:
    ...
...
class L2(Regularizer):
  ...
  Attributes:
      l2: Float; L2 regularization factor.
  """
  def __init__(self, l2=..., **kwargs) -> None:
    ...
...
l1 = L1
l2 = L2
def serialize(regularizer): # -> Any | dict[str, Any] | None:
  ...

def deserialize(config, custom_objects=...): # -> L1L2 | Any | None:
  ...

def get(identifier): # -> L1L2 | Any | Callable[..., object] | None:
