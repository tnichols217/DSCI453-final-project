...
def get_source_inputs(tensor, layer=..., node_index=...): # -> list[Any] | list[None] | object:
...
def print_summary(model, line_length=..., positions=..., print_fn=...): # -> None:
...
def cached_per_instance(f): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
