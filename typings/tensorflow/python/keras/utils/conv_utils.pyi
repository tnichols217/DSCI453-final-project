...
def deconv_output_length(input_length, filter_size, padding, output_padding=..., stride=..., dilation=...): # -> None:
...
def normalize_padding(value): # -> list[Any] | tuple[Any, ...]:
  ...
...
def conv_kernel_idxs(input_shape, kernel_shape, strides, padding, filters_in, filters_out, data_format): # -> Generator[tuple[Any, Any], Any, None]:
...
def conv_connected_inputs(input_shape, kernel_shape, output_position, strides, padding): # -> list[Any]:
...
def conv_output_shape(input_shape, kernel_shape, strides, padding): # -> tuple[Any | int | None, ...]:
...
def squeeze_batch_dims(inp, op, inner_rank): # -> Any | None:
