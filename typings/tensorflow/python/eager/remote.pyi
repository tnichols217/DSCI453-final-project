...
def connect_to_remote_host(remote_host=..., job_name=...): # -> None:
...
def connect_to_cluster(cluster_spec_or_resolver, job_name=..., task_index=..., protocol=..., make_master_device_default=..., cluster_device_filters=...):
