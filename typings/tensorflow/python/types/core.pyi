...
class FunctionType(inspect.Signature, metaclass=abc.ABCMeta):
  ...
  """
  @classmethod
  def from_callable(cls, obj, *, follow_wrapped=...): # -> Self:
    ...
...
class AtomicFunction(Callable):
  ...
  """
  def call_with_captures(self, args, kwargs, captures): # -> None:
...
@tf_export("types.experimental.PolymorphicFunction", "types.experimental.GenericFunction", v1=[])
...
class TensorProtocol(Protocol):
  ...
  def __tf_tensor__(self, dtype=..., name=...): # -> None:
