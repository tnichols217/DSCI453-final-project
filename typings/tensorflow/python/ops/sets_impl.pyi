...
def set_size(a, validate_indices=...): # -> Any:
...
@dispatch.add_dispatch_support
def set_intersection(a, b, validate_indices=...): # -> SparseTensor:
...
@dispatch.add_dispatch_support
def set_difference(a, b, aminusb=..., validate_indices=...): # -> SparseTensor:
...
@dispatch.add_dispatch_support
def set_union(a, b, validate_indices=...): # -> SparseTensor:
