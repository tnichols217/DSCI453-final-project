...
"""
def decode_csv(records: Annotated[Any, _atypes.String], record_defaults, field_delim: str = ..., use_quote_delim: bool = ..., na_value: str = ..., select_cols=..., name=...): # -> object | tuple[Any, ...] | list[Any]:
...
DecodeCSV = ...
def decode_csv_eager_fallback(records: Annotated[Any, _atypes.String], record_defaults, field_delim: str, use_quote_delim: bool, na_value: str, select_cols, name, ctx): # -> object:
  ...
...
def decode_compressed(bytes: Annotated[Any, _atypes.String], compression_type: str = ..., name=...) -> Annotated[Any, _atypes.String]:
...
def decode_json_example(json_examples: Annotated[Any, _atypes.String], name=...) -> Annotated[Any, _atypes.String]:
...
def decode_padded_raw(input_bytes: Annotated[Any, _atypes.String], fixed_length: Annotated[Any, _atypes.Int32], out_type: TV_DecodePaddedRaw_out_type, little_endian: bool = ..., name=...) -> Annotated[Any, TV_DecodePaddedRaw_out_type]:
...
def decode_raw(bytes: Annotated[Any, _atypes.String], out_type: TV_DecodeRaw_out_type, little_endian: bool = ..., name=...) -> Annotated[Any, TV_DecodeRaw_out_type]:
  r"""Reinterpret the bytes of a string as a vector of numbers.
...
_ParseExampleOutput = ...
def parse_example(serialized: Annotated[Any, _atypes.String], names: Annotated[Any, _atypes.String], sparse_keys: Annotated[List[Any], _atypes.String], dense_keys: Annotated[List[Any], _atypes.String], dense_defaults, sparse_types, dense_shapes, name=...): # -> ParseExample:
...
ParseExample = ...
def parse_example_eager_fallback(serialized: Annotated[Any, _atypes.String], names: Annotated[Any, _atypes.String], sparse_keys: Annotated[List[Any], _atypes.String], dense_keys: Annotated[List[Any], _atypes.String], dense_defaults, sparse_types, dense_shapes, name, ctx): # -> ParseExample:
  ...

_ParseExampleV2Output = ...
def parse_example_v2(serialized: Annotated[Any, _atypes.String], names: Annotated[Any, _atypes.String], sparse_keys: Annotated[Any, _atypes.String], dense_keys: Annotated[Any, _atypes.String], ragged_keys: Annotated[Any, _atypes.String], dense_defaults, num_sparse: int, sparse_types, ragged_value_types, ragged_split_types, dense_shapes, name=...): # -> ParseExampleV2:
...
ParseExampleV2 = ...
def parse_example_v2_eager_fallback(serialized: Annotated[Any, _atypes.String], names: Annotated[Any, _atypes.String], sparse_keys: Annotated[Any, _atypes.String], dense_keys: Annotated[Any, _atypes.String], ragged_keys: Annotated[Any, _atypes.String], dense_defaults, num_sparse: int, sparse_types, ragged_value_types, ragged_split_types, dense_shapes, name, ctx): # -> ParseExampleV2:
  ...

_ParseSequenceExampleOutput = ...
...
def parse_sequence_example_v2_eager_fallback(serialized: Annotated[Any, _atypes.String], debug_name: Annotated[Any, _atypes.String], context_sparse_keys: Annotated[Any, _atypes.String], context_dense_keys: Annotated[Any, _atypes.String], context_ragged_keys: Annotated[Any, _atypes.String], feature_list_sparse_keys: Annotated[Any, _atypes.String], feature_list_dense_keys: Annotated[Any, _atypes.String], feature_list_ragged_keys: Annotated[Any, _atypes.String], feature_list_dense_missing_assumed_empty: Annotated[Any, _atypes.Bool], context_dense_defaults, Ncontext_sparse: int, context_sparse_types, context_ragged_value_types, context_ragged_split_types, context_dense_shapes, Nfeature_list_sparse: int, Nfeature_list_dense: int, feature_list_dense_types, feature_list_sparse_types, feature_list_ragged_value_types, feature_list_ragged_split_types, feature_list_dense_shapes, name, ctx): # -> ParseSequenceExampleV2:
  ...

_ParseSingleExampleOutput = ...
def parse_single_example(serialized: Annotated[Any, _atypes.String], dense_defaults, num_sparse: int, sparse_keys, dense_keys, sparse_types, dense_shapes, name=...): # -> ParseSingleExample:
...
ParseSingleExample = ...
def parse_single_example_eager_fallback(serialized: Annotated[Any, _atypes.String], dense_defaults, num_sparse: int, sparse_keys, dense_keys, sparse_types, dense_shapes, name, ctx): # -> ParseSingleExample:
  ...

_ParseSingleSequenceExampleOutput = ...
...
def parse_tensor(serialized: Annotated[Any, _atypes.String], out_type: TV_ParseTensor_out_type, name=...) -> Annotated[Any, TV_ParseTensor_out_type]:
...
def serialize_tensor(tensor: Annotated[Any, TV_SerializeTensor_T], name=...) -> Annotated[Any, _atypes.String]:
...
def string_to_number(string_tensor: Annotated[Any, _atypes.String], out_type: TV_StringToNumber_out_type = ..., name=...) -> Annotated[Any, TV_StringToNumber_out_type]:
