...
def assert_integer_form(x, data=..., summarize=..., message=..., int_dtype=..., name=...): # -> object | _dispatcher_for_no_op | Operation | None:
...
def assert_symmetric(matrix): # -> IndexedSlices | Any | defaultdict[Any, Any] | list[Any] | object | None:
  ...

def embed_check_nonnegative_integer_form(x, name=...): # -> SymbolicTensor | IndexedSlices | Any | defaultdict[Any, Any] | list[Any] | object | None:
  """Assert x is a non-negative tensor, and optionally of integers."""
  ...

def same_dynamic_shape(a, b): # -> defaultdict[Any, Any] | Any | list[Any] | tuple[Any, ...] | None:
...
def maybe_get_static_value(x, dtype=...): # -> NDArray[Any] | None:
...
def get_logits_and_probs(logits=..., probs=..., multidimensional=..., validate_args=..., name=..., dtype=...): # -> tuple[Any | SymbolicTensor | IndexedSlices | defaultdict[Any, Any] | list[Any] | object | None, Any | tuple[Any, ...]] | tuple[Any | SymbolicTensor, Any] | tuple[Any, Any | SymbolicTensor | IndexedSlices | defaultdict[Any, Any] | list[Any] | object | None]:
...
def embed_check_categorical_event_shape(categorical_param, name=...): # -> SymbolicTensor | IndexedSlices | Any | defaultdict[Any, Any] | list[Any] | object | None:
...
def embed_check_integer_casting_closed(x, target_dtype, assert_nonnegative=..., name=...): # -> SymbolicTensor | IndexedSlices | Any | defaultdict[Any, Any] | list[Any] | object | None:
...
def matrix_diag_transform(matrix, transform=..., name=...): # -> SymbolicTensor | Any:
...
def rotate_transpose(x, shift, name=...): # -> SymbolicTensor | Any:
...
def pick_vector(cond, true_vector, false_vector, name=...): # -> Any:
...
def prefer_static_broadcast_shape(shape1, shape2, name=...): # -> TensorShape | Any:
...
def prefer_static_rank(x): # -> Any | Operation | _EagerTensorBase:
...
def prefer_static_shape(x): # -> Operation | _EagerTensorBase | Any:
...
def fill_triangular(x, upper=..., name=...): # -> Any:
...
def fill_triangular_inverse(x, upper=..., name=...): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
...
def tridiag(below=..., diag=..., above=..., name=...):
...
def reduce_weighted_logsumexp(logx, w=..., axis=..., keep_dims=..., return_sign=..., name=...): # -> tuple[Any, Any]:
...
def softplus_inverse(x, name=...): # -> Any:
...
def dimension_size(x, axis): # -> int | Any:
  """Returns the size of a specific dimension."""
  ...

def process_quadrature_grid_and_probs(quadrature_grid_and_probs, dtype, validate_args, name=...): # -> tuple[Any | SymbolicTensor, Any | SymbolicTensor] | tuple[Any | SymbolicTensor | defaultdict[Any, Any] | list[Any] | object | None, Any | defaultdict[Any, Any] | list[Any] | object | None]:
...
def pad(x, axis, front=..., back=..., value=..., count=..., name=...): # -> Any:
