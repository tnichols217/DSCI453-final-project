...
def for_loop(loop_fn, loop_fn_dtypes, iters, parallel_iterations=...): # -> defaultdict[Any, Any] | Any | list[Any] | None:
...
PFOR_CONFIG_ARG = ...
def pfor(loop_fn, iters, fallback_to_while_loop=..., parallel_iterations=..., warn=...): # -> defaultdict[Any, Any] | Any | list[Any] | None:
...
def vectorized_map(fn, elems, fallback_to_while_loop=..., warn=...): # -> defaultdict[Any, Any] | Any | list[Any] | None:
