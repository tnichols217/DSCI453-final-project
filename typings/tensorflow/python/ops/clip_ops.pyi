...
def clip_by_value(t, clip_value_min, clip_value_max, name=...): # -> IndexedSlices:
...
@dispatch.add_dispatch_support
def clip_by_norm(t, clip_norm, axes=..., name=...): # -> IndexedSlices | defaultdict[Any, Any] | Any | list[Any] | object | None:
...
@dispatch.add_dispatch_support
def clip_by_global_norm(t_list, clip_norm, use_norm=..., name=...): # -> tuple[list[IndexedSlices | Any], Any]:
...
@dispatch.add_dispatch_support
def clip_by_average_norm(t, clip_norm, name=...): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
