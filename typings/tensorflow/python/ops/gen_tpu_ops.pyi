...
def all_to_all(input: Annotated[Any, TV_AllToAll_T], group_assignment: Annotated[Any, _atypes.Int32], concat_dimension: int, split_dimension: int, split_count: int, name=...) -> Annotated[Any, TV_AllToAll_T]:
...
def assign_variable_xla_concat_nd(resource: Annotated[Any, _atypes.Resource], inputs: Annotated[List[Any], TV_AssignVariableXlaConcatND_T], num_concats, paddings=..., name=...): # -> object | Operation | None:
...
def assign_variable_xla_concat_nd_eager_fallback(resource: Annotated[Any, _atypes.Resource], inputs: Annotated[List[Any], TV_AssignVariableXlaConcatND_T], num_concats, paddings, name, ctx): # -> None:
  ...
...
def collective_permute(input: Annotated[Any, TV_CollectivePermute_T], source_target_pairs: Annotated[Any, _atypes.Int32], name=...) -> Annotated[Any, TV_CollectivePermute_T]:
...
def configure_distributed_tpu(embedding_config: str = ..., tpu_embedding_config: str = ..., is_global_init: bool = ..., enable_whole_mesh_compilations: bool = ..., compilation_failure_closes_chips: bool = ..., tpu_cancellation_closes_chips: int = ..., name=...) -> Annotated[Any, _atypes.String]:
...
def configure_tpu_embedding(config: str, name=...): # -> object | Operation | None:
...
def configure_tpu_embedding_eager_fallback(config: str, name, ctx): # -> None:
  ...
...
def cross_replica_sum(input: Annotated[Any, TV_CrossReplicaSum_T], group_assignment: Annotated[Any, _atypes.Int32], name=...) -> Annotated[Any, TV_CrossReplicaSum_T]:
...
def enqueue_tpu_embedding_integer_batch_eager_fallback(batch: Annotated[List[Any], _atypes.Int32], mode_override: Annotated[Any, _atypes.String], device_ordinal: int, name, ctx): # -> None:
  ...
...
def infeed_dequeue(dtype: TV_InfeedDequeue_dtype, shape, name=...) -> Annotated[Any, TV_InfeedDequeue_dtype]:
...
InfeedDequeueTuple = ...
def infeed_dequeue_tuple_eager_fallback(dtypes, shapes, name, ctx): # -> object:
  ...
...
def infeed_enqueue(input: Annotated[Any, TV_InfeedEnqueue_dtype], shape=..., layout=..., device_ordinal: int = ..., name=...): # -> object | Operation | None:
...
InfeedEnqueue = ...
def infeed_enqueue_eager_fallback(input: Annotated[Any, TV_InfeedEnqueue_dtype], shape, layout, device_ordinal: int, name, ctx): # -> None:
  ...

def infeed_enqueue_prelinearized_buffer(input: Annotated[Any, _atypes.Variant], device_ordinal: int = ..., name=...): # -> object | Operation | None:
...
def infeed_enqueue_prelinearized_buffer_eager_fallback(input: Annotated[Any, _atypes.Variant], device_ordinal: int, name, ctx): # -> None:
  ...

def infeed_enqueue_tuple(inputs, shapes, layouts=..., device_ordinal: int = ..., name=...): # -> object | Operation | None:
...
InfeedEnqueueTuple = ...
def infeed_enqueue_tuple_eager_fallback(inputs, shapes, layouts, device_ordinal: int, name, ctx): # -> None:
  ...

def is_tpu_embedding_initialized(config: str = ..., name=...) -> Annotated[Any, _atypes.Bool]:
...
def load_tpu_embedding_adam_parameters(parameters: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], velocities: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_adam_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], velocities: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_adadelta_parameters(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], updates: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_adadelta_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], updates: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_adagrad_momentum_parameters(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_adagrad_momentum_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_adagrad_parameters(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_adagrad_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_centered_rms_prop_parameters(parameters: Annotated[Any, _atypes.Float32], ms: Annotated[Any, _atypes.Float32], mom: Annotated[Any, _atypes.Float32], mg: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_centered_rms_prop_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], ms: Annotated[Any, _atypes.Float32], mom: Annotated[Any, _atypes.Float32], mg: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_ftrl_parameters(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], linears: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_ftrl_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], linears: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_frequency_estimator_parameters(parameters: Annotated[Any, _atypes.Float32], last_hit_step: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_frequency_estimator_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], last_hit_step: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_mdl_adagrad_light_parameters(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], benefits: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], weights: Annotated[Any, _atypes.Float32], benefits: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_momentum_parameters(parameters: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_momentum_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], momenta: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_proximal_adagrad_parameters(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_proximal_adagrad_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], accumulators: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_proximal_yogi_parameters(parameters: Annotated[Any, _atypes.Float32], v: Annotated[Any, _atypes.Float32], m: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
  r"""TODO: add doc.
...
def load_tpu_embedding_proximal_yogi_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], v: Annotated[Any, _atypes.Float32], m: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_rms_prop_parameters(parameters: Annotated[Any, _atypes.Float32], ms: Annotated[Any, _atypes.Float32], mom: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_rms_prop_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], ms: Annotated[Any, _atypes.Float32], mom: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...

def load_tpu_embedding_stochastic_gradient_descent_parameters(parameters: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> object | Operation | None:
...
def load_tpu_embedding_stochastic_gradient_descent_parameters_eager_fallback(parameters: Annotated[Any, _atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> None:
  ...
...
def outfeed_dequeue(dtype: TV_OutfeedDequeue_dtype, shape, device_ordinal: int = ..., name=...) -> Annotated[Any, TV_OutfeedDequeue_dtype]:
...
def outfeed_dequeue_tuple(dtypes, shapes, device_ordinal: int = ..., name=...): # -> object | Operation | tuple[Any, ...] | list[Any]:
...
OutfeedDequeueTuple = ...
def outfeed_dequeue_tuple_eager_fallback(dtypes, shapes, device_ordinal: int, name, ctx): # -> object:
  ...

def outfeed_dequeue_tuple_v2(device_ordinal: Annotated[Any, _atypes.Int32], dtypes, shapes, name=...): # -> object | Operation | tuple[Any, ...] | list[Any]:
...
def outfeed_dequeue_tuple_v2_eager_fallback(device_ordinal: Annotated[Any, _atypes.Int32], dtypes, shapes, name, ctx): # -> object:
  ...
...
def outfeed_dequeue_v2(device_ordinal: Annotated[Any, _atypes.Int32], dtype: TV_OutfeedDequeueV2_dtype, shape, name=...) -> Annotated[Any, TV_OutfeedDequeueV2_dtype]:
...
def outfeed_enqueue(input: Annotated[Any, TV_OutfeedEnqueue_dtype], name=...): # -> object | Operation | None:
...
OutfeedEnqueue = ...
def outfeed_enqueue_eager_fallback(input: Annotated[Any, TV_OutfeedEnqueue_dtype], name, ctx): # -> None:
  ...

def outfeed_enqueue_tuple(inputs, name=...): # -> object | Operation | None:
...
OutfeedEnqueueTuple = ...
def outfeed_enqueue_tuple_eager_fallback(inputs, name, ctx): # -> None:
  ...
...
def prelinearize(input: Annotated[Any, TV_Prelinearize_dtype], shape=..., layout=..., name=...) -> Annotated[Any, _atypes.Variant]:
...
def prelinearize_tuple(inputs, shapes, layouts=..., name=...) -> Annotated[Any, _atypes.Variant]:
...
def read_variable_xla_split_nd(resource: Annotated[Any, _atypes.Resource], T: TV_ReadVariableXlaSplitND_T, N: int, num_splits, paddings=..., name=...): # -> object | Operation | tuple[Any, ...] | list[Any]:
...
def read_variable_xla_split_nd_eager_fallback(resource: Annotated[Any, _atypes.Resource], T: TV_ReadVariableXlaSplitND_T, N: int, num_splits, paddings, name, ctx): # -> object:
  ...

def recv_tpu_embedding_activations(num_outputs: int, config: str, name=...): # -> object | Operation | tuple[Any, ...] | list[Any]:
...
def recv_tpu_embedding_activations_eager_fallback(num_outputs: int, config: str, name, ctx): # -> object:
  ...

_RetrieveTPUEmbeddingADAMParametersOutput = ...
def retrieve_tpu_embedding_adam_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingADAMParameters:
...
def retrieve_tpu_embedding_adam_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingADAMParameters:
  ...

_RetrieveTPUEmbeddingAdadeltaParametersOutput = ...
def retrieve_tpu_embedding_adadelta_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingAdadeltaParameters:
...
def retrieve_tpu_embedding_adadelta_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingAdadeltaParameters:
  ...

_RetrieveTPUEmbeddingAdagradMomentumParametersOutput = ...
def retrieve_tpu_embedding_adagrad_momentum_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingAdagradMomentumParameters:
...
def retrieve_tpu_embedding_adagrad_momentum_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingAdagradMomentumParameters:
  ...

_RetrieveTPUEmbeddingAdagradParametersOutput = ...
def retrieve_tpu_embedding_adagrad_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingAdagradParameters:
...
def retrieve_tpu_embedding_adagrad_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingAdagradParameters:
  ...

_RetrieveTPUEmbeddingCenteredRMSPropParametersOutput = ...
def retrieve_tpu_embedding_centered_rms_prop_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingCenteredRMSPropParameters:
...
def retrieve_tpu_embedding_centered_rms_prop_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingCenteredRMSPropParameters:
  ...

_RetrieveTPUEmbeddingFTRLParametersOutput = ...
def retrieve_tpu_embedding_ftrl_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingFTRLParameters:
...
def retrieve_tpu_embedding_ftrl_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingFTRLParameters:
  ...

_RetrieveTPUEmbeddingFrequencyEstimatorParametersOutput = ...
def retrieve_tpu_embedding_frequency_estimator_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingFrequencyEstimatorParameters:
...
def retrieve_tpu_embedding_frequency_estimator_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingFrequencyEstimatorParameters:
  ...

_RetrieveTPUEmbeddingMDLAdagradLightParametersOutput = ...
def retrieve_tpu_embedding_mdl_adagrad_light_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingMDLAdagradLightParameters:
...
def retrieve_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingMDLAdagradLightParameters:
  ...

_RetrieveTPUEmbeddingMomentumParametersOutput = ...
def retrieve_tpu_embedding_momentum_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingMomentumParameters:
...
def retrieve_tpu_embedding_momentum_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingMomentumParameters:
  ...

_RetrieveTPUEmbeddingProximalAdagradParametersOutput = ...
def retrieve_tpu_embedding_proximal_adagrad_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingProximalAdagradParameters:
...
def retrieve_tpu_embedding_proximal_adagrad_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingProximalAdagradParameters:
  ...

_RetrieveTPUEmbeddingProximalYogiParametersOutput = ...
def retrieve_tpu_embedding_proximal_yogi_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingProximalYogiParameters:
  r"""TODO: add doc.
...
def retrieve_tpu_embedding_proximal_yogi_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingProximalYogiParameters:
  ...

_RetrieveTPUEmbeddingRMSPropParametersOutput = ...
def retrieve_tpu_embedding_rms_prop_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...): # -> RetrieveTPUEmbeddingRMSPropParameters:
...
def retrieve_tpu_embedding_rms_prop_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx): # -> RetrieveTPUEmbeddingRMSPropParameters:
  ...

def retrieve_tpu_embedding_stochastic_gradient_descent_parameters(num_shards: int, shard_id: int, table_id: int = ..., table_name: str = ..., config: str = ..., name=...) -> Annotated[Any, _atypes.Float32]:
...
def send_tpu_embedding_gradients(inputs: Annotated[List[Any], _atypes.Float32], learning_rates: Annotated[List[Any], _atypes.Float32], config: str, name=...): # -> object | Operation | None:
...
def send_tpu_embedding_gradients_eager_fallback(inputs: Annotated[List[Any], _atypes.Float32], learning_rates: Annotated[List[Any], _atypes.Float32], config: str, name, ctx): # -> None:
  ...

def shutdown_distributed_tpu(name=...): # -> object | Operation | None:
...
def shutdown_distributed_tpu_eager_fallback(name, ctx): # -> None:
  ...

def tpu_compilation_result(name=...) -> Annotated[Any, _atypes.String]:
...
def tpu_embedding_activations(embedding_variable: Annotated[Any, _atypes.Float32], sliced_activations: Annotated[Any, _atypes.Float32], table_id: int, lookup_id: int, name=...) -> Annotated[Any, _atypes.Float32]:
...
def tpu_ordinal_selector(name=...) -> Annotated[Any, _atypes.Int32]:
...
def tpu_partitioned_call(args, device_ordinal: Annotated[Any, _atypes.Int32], Tout, f, autotuner_thresh: int = ..., name=...): # -> object | tuple[Any, ...] | list[Any]:
...
TPUPartitionedCall = ...
def tpu_partitioned_call_eager_fallback(args, device_ordinal: Annotated[Any, _atypes.Int32], Tout, f, autotuner_thresh: int, name, ctx): # -> object:
  ...

def tpu_replicate_metadata(num_replicas: int, num_cores_per_replica: int = ..., topology: str = ..., use_tpu: bool = ..., device_assignment=..., computation_shape=..., host_compute_core=..., padding_map=..., step_marker_location: str = ..., allow_soft_placement: bool = ..., use_spmd_for_xla_partitioning: bool = ..., tpu_compile_options_proto: str = ..., name=...): # -> object | Operation | None:
...
def tpu_replicate_metadata_eager_fallback(num_replicas: int, num_cores_per_replica: int, topology: str, use_tpu: bool, device_assignment, computation_shape, host_compute_core, padding_map, step_marker_location: str, allow_soft_placement: bool, use_spmd_for_xla_partitioning: bool, tpu_compile_options_proto: str, name, ctx): # -> None:
  ...
...
def tpu_replicated_input(inputs: Annotated[List[Any], TV_TPUReplicatedInput_T], is_mirrored_variable: bool = ..., index: int = ..., is_packed: bool = ..., name=...) -> Annotated[Any, TV_TPUReplicatedInput_T]:
...
def tpu_replicated_output(input: Annotated[Any, TV_TPUReplicatedOutput_T], num_replicas: int, name=...): # -> object | tuple[Any, ...] | list[Any]:
...
TPUReplicatedOutput = ...
def tpu_replicated_output_eager_fallback(input: Annotated[Any, TV_TPUReplicatedOutput_T], num_replicas: int, name, ctx): # -> object:
  ...

def worker_heartbeat(request: Annotated[Any, _atypes.String], name=...) -> Annotated[Any, _atypes.String]:
...
def xla_concat_nd(inputs: Annotated[List[Any], TV_XlaConcatND_T], num_concats, paddings=..., name=...) -> Annotated[Any, TV_XlaConcatND_T]:
  r"""Concats input tensor across all dimensions.
...
def xla_split_nd(input: Annotated[Any, TV_XlaSplitND_T], N: int, num_splits, paddings=..., name=...): # -> object | tuple[Any, ...] | list[Any]:
...
XlaSplitND = ...
def xla_split_nd_eager_fallback(input: Annotated[Any, TV_XlaSplitND_T], N: int, num_splits, paddings, name, ctx): # -> object:
  ...
