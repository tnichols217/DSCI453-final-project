...
def batch_function(num_batch_threads, max_batch_size, batch_timeout_micros, allowed_batch_sizes=..., max_enqueued_batches=..., autograph=..., enable_large_batch_splitting=...): # -> Callable[..., Callable[..., Any | defaultdict[Any, Any] | list[Any] | None]]:
