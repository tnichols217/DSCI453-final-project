...
"""
_DecodeProtoV2Output = ...
@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('io.decode_proto')
def decode_proto_v2(bytes: Annotated[Any, _atypes.String], message_type: str, field_names, output_types, descriptor_source: str = ..., message_format: str = ..., sanitize: bool = ..., name=...): # -> DecodeProtoV2 | _dispatcher_for_decode_proto_v2 | object:
...
def decode_proto_v2_eager_fallback(bytes: Annotated[Any, _atypes.String], message_type: str, field_names, output_types, descriptor_source: str, message_format: str, sanitize: bool, name, ctx): # -> DecodeProtoV2:
  ...
