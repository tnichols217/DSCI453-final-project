...
def gradients(ys, xs, grad_ys=..., name=..., colocate_gradients_with_ops=..., gate_gradients=..., aggregation_method=..., stop_gradients=..., unconnected_gradients=...):
...
def gradients_v2(ys, xs, grad_ys=..., name=..., gate_gradients=..., aggregation_method=..., stop_gradients=..., unconnected_gradients=...):
  """Constructs symbolic derivatives of sum of `ys` w.r.t. x in `xs`.
...
def hessians(ys, xs, name=..., colocate_gradients_with_ops=..., gate_gradients=..., aggregation_method=...): # -> list[Any]:
...
def HessiansV2(ys, xs, gate_gradients=..., aggregation_method=..., name=...): # -> list[Any]:
  """Constructs the Hessian of sum of `ys` with respect to `x` in `xs`.
