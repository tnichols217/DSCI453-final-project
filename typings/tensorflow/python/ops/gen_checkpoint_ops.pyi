...
def generate_vocab_remapping(new_vocab_file: Annotated[Any, _atypes.String], old_vocab_file: Annotated[Any, _atypes.String], new_vocab_offset: int, num_new_vocab: int, old_vocab_size: int = ..., name=...): # -> GenerateVocabRemapping:
...
def generate_vocab_remapping_eager_fallback(new_vocab_file: Annotated[Any, _atypes.String], old_vocab_file: Annotated[Any, _atypes.String], new_vocab_offset: int, num_new_vocab: int, old_vocab_size: int, name, ctx): # -> GenerateVocabRemapping:
  ...

def load_and_remap_matrix(ckpt_path: Annotated[Any, _atypes.String], old_tensor_name: Annotated[Any, _atypes.String], row_remapping: Annotated[Any, _atypes.Int64], col_remapping: Annotated[Any, _atypes.Int64], initializing_values: Annotated[Any, _atypes.Float32], num_rows: int, num_cols: int, max_rows_in_memory: int = ..., name=...) -> Annotated[Any, _atypes.Float32]:
