...
@dispatch.add_dispatch_support
def inverse_stft_window_fn(frame_step, forward_window_fn=..., name=...): # -> Callable[..., Any]:
...
@dispatch.add_dispatch_support
def inverse_stft(stfts, frame_length, frame_step, fft_length=..., window_fn=..., name=...): # -> Any:
...
@dispatch.add_dispatch_support
def mdct(signals, frame_length, window_fn=..., pad_end=..., norm=..., name=...): # -> SymbolicTensor | Any | None:
...
@dispatch.add_dispatch_support
def inverse_mdct(mdcts, window_fn=..., norm=..., name=...): # -> Any:
