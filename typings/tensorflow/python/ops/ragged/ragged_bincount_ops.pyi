...
from tensorflow.python.ops import bincount_ops, sparse_ops
from tensorflow.python.ops.ragged import ragged_tensor
from tensorflow.python.util import dispatch

"""bincount ops for RaggedTensors."""
@dispatch.dispatch_for_api(bincount_ops.bincount)
def bincount(arr: ragged_tensor.RaggedTensor, weights=..., minlength=..., maxlength=..., dtype=..., name=..., axis=..., binary_output=...):
...
def sparse_bincount(values: ragged_tensor.RaggedTensor, weights=..., axis=..., minlength=..., maxlength=..., binary_output=..., name=...): # -> SparseTensor:
...
def validate_ragged_weights(values, weights, dtype=...): # -> Operation | _EagerTensorBase | defaultdict[Any, Any] | Any | list[Any] | object | RaggedTensor | None:
