...
def string_bytes_split(input, name=...): # -> RaggedTensor:
...
@dispatch.add_dispatch_support
def unicode_encode(input, output_encoding, errors=..., replacement_char=..., name=...): # -> RaggedTensor | Any:
...
@dispatch.add_dispatch_support
def unicode_decode(input, input_encoding, errors=..., replacement_char=..., replace_control_characters=..., name=...): # -> tuple[Any, Any]:
...
@dispatch.add_dispatch_support
def unicode_decode_with_offsets(input, input_encoding, errors=..., replacement_char=..., replace_control_characters=..., name=...): # -> tuple[Any, Any]:
...
@dispatch.add_dispatch_support
def unicode_split(input, input_encoding, errors=..., replacement_char=..., name=...): # -> RaggedTensor | Any:
...
@dispatch.add_dispatch_support
def unicode_split_with_offsets(input, input_encoding, errors=..., replacement_char=..., name=...): # -> tuple[Any | RaggedTensor, Any]:
...
@dispatch.add_dispatch_support
def string_split_v2(input, sep=..., maxsplit=..., name=...): # -> RaggedTensor:
...
def string_split(source, sep=..., skip_empty=..., delimiter=..., result_type=..., name=...): # -> SparseTensor:
...
@dispatch.add_dispatch_support
def strings_split_v1(input=..., sep=..., maxsplit=..., result_type=..., source=..., name=...): # -> SparseTensor | RaggedTensor:
...
def reduce_join(inputs: ragged_tensor.Ragged, axis=..., keepdims=..., separator=..., name=...): # -> Any | RaggedTensor:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...

@tf_export("strings.ngrams")
@dispatch.add_dispatch_support
def ngrams(data, ngram_width, separator=..., pad_values=..., padding_width=..., preserve_short_sequences=..., name=...): # -> Any | RaggedTensor:
...
def string_format(template: str, inputs: typing.Union[ragged_tensor.Ragged, typing.List[ragged_tensor.RaggedOrDense]], placeholder=..., summarize=..., name=...): # -> Operation | _EagerTensorBase | Any:
  """Version of tf.strings.format that handles RaggedTensors."""
  ...

def ragged_tensor_to_string(rt, summarize=...): # -> Any:
...
def string_join(inputs: typing.List[ragged_tensor.RaggedOrDense], separator=..., name=...):
