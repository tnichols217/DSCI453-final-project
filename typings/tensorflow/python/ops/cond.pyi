...
def cond(pred, true_fn=..., false_fn=..., strict=..., name=..., fn1=..., fn2=...): # -> defaultdict[Any, Any] | Any | list[Any] | tuple[Any, ...] | None:
...
@tf_export("cond", v1=[])
@dispatch.add_dispatch_support
def cond_for_tf_v2(pred, true_fn=..., false_fn=..., name=...): # -> defaultdict[Any, Any] | Any | list[Any] | tuple[Any, ...] | None:
  """Return `true_fn()` if the predicate `pred` is true else `false_fn()`.
