...
def uniform_candidate_sampler(true_classes, num_true, num_sampled, unique, range_max, seed=..., name=...): # -> UniformCandidateSampler:
...
def log_uniform_candidate_sampler(true_classes, num_true, num_sampled, unique, range_max, seed=..., name=...): # -> LogUniformCandidateSampler:
...
def learned_unigram_candidate_sampler(true_classes, num_true, num_sampled, unique, range_max, seed=..., name=...): # -> LearnedUnigramCandidateSampler:
...
@dispatch.add_dispatch_support
def fixed_unigram_candidate_sampler(true_classes, num_true, num_sampled, unique, range_max, vocab_file=..., distortion=..., num_reserved_ids=..., num_shards=..., shard=..., unigrams=..., seed=..., name=...): # -> FixedUnigramCandidateSampler:
...
def all_candidate_sampler(true_classes, num_true, num_sampled, unique, seed=..., name=...): # -> AllCandidateSampler:
...
@dispatch.add_dispatch_support
def compute_accidental_hits(true_classes, sampled_candidates, num_true, seed=..., name=...): # -> ComputeAccidentalHits:
