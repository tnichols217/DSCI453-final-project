...
def default_variable_creator(next_creator=..., **kwds): # -> ResourceVariable | RefVariable:
  ...
...
class VariableV1(variables.Variable):
  ...
  * Call `tf.compat.v1.get_variable_scope().set_use_resource(True)` inside a
  ...
  """
  def __init__(self, initial_value=..., trainable=..., collections=..., validate_shape=..., caching_device=..., name=..., variable_def=..., dtype=..., expected_shape=..., import_scope=..., constraint=..., use_resource=..., synchronization=..., aggregation=..., shape=...) -> None:
  ...
  def initialized_value(self): # -> defaultdict[Any, Any] | Any | list[Any] | tuple[Any, ...] | None:
    ...
  
  @staticmethod
  def from_proto(variable_def, import_scope=...): # -> RefVariable:
    ...
