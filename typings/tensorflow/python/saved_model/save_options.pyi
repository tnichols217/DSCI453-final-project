...
class VariablePolicy(enum.Enum):
  ...
  EXPAND_DISTRIBUTED_VARIABLES = ...
  @staticmethod
  def from_obj(obj): # -> VariablePolicy:
...
class SaveOptions:
  ...
  """
  __slots__ = ...
  def __init__(self, namespace_whitelist=..., save_debug_info=..., function_aliases=..., experimental_debug_stripper=..., experimental_io_device=..., experimental_variable_policy=..., experimental_custom_gradients=..., experimental_image_format=..., experimental_skip_saver=..., experimental_sharding_callback=..., extra_tags=...) -> None:
