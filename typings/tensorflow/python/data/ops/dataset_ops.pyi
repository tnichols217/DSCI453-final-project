...
from tensorflow.python.data.ops import iterator_ops, structured_function
from tensorflow.python.framework import composite_tensor, type_spec
from tensorflow.python.trackable import base as tracking_base, resource as resource_lib
...
COMPRESSION_GZIP = ...
COMPRESSION_SNAPPY = ...
DATASET_SPEC_FILENAME = ...
def get_type(value): # -> type[Any]:
...
class DatasetV2(collections_abc.Iterable, tracking_base.Trackable, composite_tensor.CompositeTensor, data_types.DatasetV2, metaclass=abc.ABCMeta):
  ...
  **Component**: The leaf in the nested structure of an element.
  ...
  def __debug_string__(self): # -> LiteralString:
  ...
  def as_numpy_iterator(self): # -> NumpyIterator:
  ...
  @staticmethod
  def from_tensors(tensors, name=...) -> DatasetV2:
  ...
  @staticmethod
  def from_tensor_slices(tensors, name=...) -> DatasetV2:
  ...
  class _GeneratorState:
    ...
    def get_next_id(self, *args): # -> NDArray[signedinteger[_64Bit]]:
      ...
  ...
  def from_generator(generator, output_types=..., output_shapes=..., args=..., output_signature=..., name=...) -> DatasetV2:
  ...
  @staticmethod
  def zip(*args, datasets=..., name=...) -> DatasetV2:
  ...
  def concatenate(self, dataset, name=...) -> DatasetV2:
  ...
  @staticmethod
  def counter(start=..., step=..., dtype=..., name=...) -> DatasetV2:
  ...
  def rebatch(self, batch_size, drop_remainder=..., name=...) -> DatasetV2:
  ...
  def prefetch(self, buffer_size, name=...) -> DatasetV2:
  ...
  @staticmethod
  def list_files(file_pattern, shuffle=..., seed=..., name=...) -> DatasetV2:
  ...
  def repeat(self, count=..., name=...) -> DatasetV2:
  ...
  def enumerate(self, start=..., name=...) -> DatasetV2:
  ...
  def shuffle(self, buffer_size, seed=..., reshuffle_each_iteration=..., name=...) -> DatasetV2:
  ...
  def cache(self, filename=..., name=...) -> DatasetV2:
  ...
  def take(self, count, name=...) -> DatasetV2:
  ...
  def skip(self, count, name=...) -> DatasetV2:
  ...
  def shard(self, num_shards, index, name=...) -> DatasetV2:
  ...
  def save(self, path, compression=..., shard_func=..., checkpoint_args=...): # -> object | Operation | None:
  ...
  @staticmethod
  def load(path, element_spec=..., compression=..., reader_func=..., wait=...) -> DatasetV2:
  ...
  def batch(self, batch_size, drop_remainder=..., num_parallel_calls=..., deterministic=..., name=...) -> DatasetV2:
  ...
  def padded_batch(self, batch_size, padded_shapes=..., padding_values=..., drop_remainder=..., name=...) -> DatasetV2:
  ...
  def ragged_batch(self, batch_size, drop_remainder=..., row_splits_dtype=..., name=...) -> DatasetV2:
  ...
  def sparse_batch(self, batch_size, row_shape, name=...) -> DatasetV2:
  ...
  def map(self, map_func, num_parallel_calls=..., deterministic=..., synchronous=..., use_unbounded_threadpool=..., name=...) -> DatasetV2:
...
name=None))
  ...
  def flat_map(self, map_func, name=...) -> DatasetV2:
  ...
  def ignore_errors(self, log_warning=..., name=...) -> DatasetV2:
  ...
  def interleave(self, map_func, cycle_length=..., block_length=..., num_parallel_calls=..., deterministic=..., name=...) -> DatasetV2:
  ...
  def filter(self, predicate, name=...) -> DatasetV2:
  ...
  def window(self, size, shift=..., stride=..., drop_remainder=..., name=...) -> DatasetV2:
  ...
  def reduce(self, initial_state, reduce_func, name=...): # -> defaultdict[Any, Any] | Any | list[Any] | None:
  ...
  def get_single_element(self, name=...): # -> defaultdict[Any, Any] | Any | list[Any] | None:
  ...
  def unbatch(self, name=...) -> DatasetV2:
  ...
  def with_options(self, options, name=...) -> DatasetV2:
  ...
  def group_by_window(self, key_func, reduce_func, window_size=..., window_size_func=..., name=...) -> DatasetV2:
  ...
  def bucket_by_sequence_length(self, element_length_func, bucket_boundaries, bucket_batch_sizes, padded_shapes=..., padding_values=..., pad_to_bucket_boundary=..., no_padding=..., drop_remainder=..., name=...) -> DatasetV2:
  ...
  @staticmethod
  def random(seed=..., rerandomize_each_iteration=..., name=...) -> DatasetV2:
  ...
  def snapshot(self, path, compression=..., reader_func=..., shard_func=..., name=...) -> DatasetV2:
  ...
  def scan(self, initial_state, scan_func, name=...) -> DatasetV2:
  ...
  def take_while(self, predicate, name=...) -> DatasetV2:
  ...
  def unique(self, name=...) -> DatasetV2:
  ...
  def rejection_resample(self, class_func, target_dist, initial_dist=..., seed=..., name=...) -> DatasetV2:
  ...
  @staticmethod
  def sample_from_datasets(datasets, weights=..., seed=..., stop_on_empty_dataset=..., rerandomize_each_iteration=...) -> DatasetV2:
  ...
  @staticmethod
  def choose_from_datasets(datasets, choice_dataset, stop_on_empty_dataset=...) -> DatasetV2:
...
class DatasetV1(DatasetV2, data_types.DatasetV1):
  ...
  def make_initializable_iterator(self, shared_name=...) -> iterator_ops.Iterator:
    """Creates an iterator for elements of this dataset.
  ...
  def from_tensors(tensors, name=...): # -> DatasetV1Adapter:
    ...
  
  @staticmethod
  @functools.wraps(DatasetV2.from_tensor_slices)
  def from_tensor_slices(tensors, name=...): # -> DatasetV1Adapter:
    ...
  
  @staticmethod
  @deprecation.deprecated(None, "Use `tf.data.Dataset.from_tensor_slices()`.")
  def from_sparse_tensor_slices(sparse_tensor): # -> DatasetV1Adapter:
  ...
  @deprecation.deprecated_args(None, "Use output_signature instead", "output_types", "output_shapes")
  def from_generator(generator, output_types=..., output_shapes=..., args=..., output_signature=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @staticmethod
  @functools.wraps(DatasetV2.range)
  def range(*args, **kwargs): # -> DatasetV1Adapter:
    ...
  
  @staticmethod
  @functools.wraps(DatasetV2.zip)
  def zip(*args, datasets=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.concatenate)
  def concatenate(self, dataset, name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.prefetch)
  def prefetch(self, buffer_size, name=...): # -> DatasetV1Adapter:
    ...
  
  @staticmethod
  @functools.wraps(DatasetV2.list_files)
  def list_files(file_pattern, shuffle=..., seed=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.repeat)
  def repeat(self, count=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.shuffle)
  def shuffle(self, buffer_size, seed=..., reshuffle_each_iteration=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.cache)
  def cache(self, filename=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.take)
  def take(self, count, name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.skip)
  def skip(self, count, name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.shard)
  def shard(self, num_shards, index, name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.batch)
  def batch(self, batch_size, drop_remainder=..., num_parallel_calls=..., deterministic=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.padded_batch)
  def padded_batch(self, batch_size, padded_shapes=..., padding_values=..., drop_remainder=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.map)
  def map(self, map_func, num_parallel_calls=..., deterministic=..., synchronous=..., use_unbounded_threadpool=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @deprecation.deprecated(None, "Use `tf.data.Dataset.map()")
  def map_with_legacy_function(self, map_func, num_parallel_calls=..., deterministic=..., use_unbounded_threadpool=...) -> DatasetV1Adapter:
    """Maps `map_func` across the elements of this dataset.
  ...
  def flat_map(self, map_func, name=...) -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.interleave)
  def interleave(self, map_func, cycle_length=..., block_length=..., num_parallel_calls=..., deterministic=..., name=...) -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.filter)
  def filter(self, predicate, name=...) -> DatasetV1Adapter:
    ...
  ...
  def window(self, size, shift=..., stride=..., drop_remainder=..., name=...) -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.unbatch)
  def unbatch(self, name=...) -> DatasetV1Adapter:
    ...
  
  @functools.wraps(DatasetV2.with_options)
  def with_options(self, options, name=...) -> DatasetV1Adapter:
    ...
...
class DatasetV1Adapter(DatasetV1):
  ...
  def __init__(self, dataset: DatasetV2) -> None:
    ...
  ...
  def __iter__(self): # -> OwnedIterator:
    ...
...
def make_initializable_iterator(dataset: DatasetV1, shared_name=...) -> iterator_ops.Iterator:
  """Creates an iterator for elements of `dataset`.
...
def get_legacy_output_classes(dataset_or_iterator): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
...
def get_legacy_output_shapes(dataset_or_iterator): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
...
def get_legacy_output_types(dataset_or_iterator): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
  """Returns the output shapes for elements of the input dataset / iterator.
...
class UnaryDataset(DatasetV2):
  ...
  def __init__(self, input_dataset: DatasetV2, variant_tensor) -> None:
    ...
...
def from_variant(variant, structure): # -> _VariantDataset:
...
def to_variant(dataset: DatasetV2): # -> Any:
...
class DatasetSpec(type_spec.BatchableTypeSpec):
  ...
  @property
  def value_type(self): # -> type[DatasetV2] | type[DatasetV1]:
    ...
  ...
  def most_specific_common_supertype(self, others): # -> DatasetSpec | None:
    """See base class."""
    ...
  
  @staticmethod
  def from_value(value): # -> DatasetSpec:
...
class NumpyIterator(tracking_base.Trackable):
  ...
  def next(self): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
    ...
...
def normalize_to_dense(dataset: Dataset): # -> _RestructuredDataset:
