...
def flatten(structure): # -> list[None] | object:
  ...

def assert_same_structure(nest1, nest2, check_types=...): # -> None:
...
def map_structure(func, *structure, **check_types_dict): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
...
def flatten_up_to(shallow_tree, input_tree): # -> list[Any]:
...
def map_structure_up_to(shallow_tree, func, *inputs): # -> defaultdict[Any, Any] | Any | list[Any] | None:
