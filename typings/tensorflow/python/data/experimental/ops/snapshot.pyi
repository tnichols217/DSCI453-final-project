...
class _LegacySnapshotDataset(dataset_ops.UnaryUnchangedStructureDataset):
  ...
  def __init__(self, input_dataset, path, compression=..., reader_path_prefix=..., writer_path_prefix=..., shard_size_bytes=..., pending_snapshot_expiry_seconds=..., num_reader_threads=..., reader_buffer_size=..., num_writer_threads=..., writer_buffer_size=..., shuffle_on_read=..., shuffle_seed=..., mode=..., snapshot_name=...) -> None:
    ...
  


@deprecation.deprecated(None, "Use `tf.data.Dataset.shapshot(...)` instead.")
def legacy_snapshot(path, compression=..., reader_path_prefix=..., writer_path_prefix=..., shard_size_bytes=..., pending_snapshot_expiry_seconds=..., num_reader_threads=..., reader_buffer_size=..., num_writer_threads=..., writer_buffer_size=..., shuffle_on_read=..., shuffle_seed=..., mode=..., snapshot_name=...): # -> Callable[..., _LegacySnapshotDataset]:
...
def snapshot(path, compression=..., reader_func=..., shard_func=...): # -> Callable[..., Any]:
