...
def dense_to_ragged_batch(batch_size, drop_remainder=..., row_splits_dtype=...): # -> Callable[..., Any]:
...
def dense_to_sparse_batch(batch_size, row_shape): # -> Callable[..., Any]:
...
def map_and_batch_with_legacy_function(map_func, batch_size, num_parallel_batches=..., drop_remainder=..., num_parallel_calls=...): # -> Callable[..., _MapAndBatchDataset]:
...
def map_and_batch(map_func, batch_size, num_parallel_batches=..., drop_remainder=..., num_parallel_calls=...): # -> Callable[..., _MapAndBatchDataset]:
  """Fused implementation of `map` and `batch`.
...
class _MapAndBatchDataset(dataset_ops.UnaryDataset):
  ...
  def __init__(self, input_dataset, map_func, batch_size, num_parallel_calls, drop_remainder, use_legacy_function=...) -> None:
    ...
