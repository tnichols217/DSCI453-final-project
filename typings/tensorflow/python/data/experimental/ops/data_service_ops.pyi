...
def distribute(processing_mode, service, job_name=..., consumer_index=..., num_consumers=..., max_outstanding_requests=..., data_transfer_protocol=..., compression=..., cross_trainer_cache=..., target_workers=...) -> Callable[dataset_ops.Dataset, dataset_ops.Dataset]:
...
def register_dataset(service, dataset, compression=..., dataset_id=...) -> tensor.Tensor:
...
def from_dataset_id(processing_mode, service, dataset_id, element_spec=..., job_name=..., consumer_index=..., num_consumers=..., max_outstanding_requests=..., data_transfer_protocol=..., cross_trainer_cache=..., target_workers=...) -> dataset_ops.Dataset:
