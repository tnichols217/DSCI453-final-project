...
def parallel_interleave(map_func, cycle_length, block_length=..., sloppy=..., buffer_output_elements=..., prefetch_input_elements=...): # -> Callable[..., ParallelInterleaveDataset]:
...
def sample_from_datasets_v2(datasets, weights=..., seed=..., stop_on_empty_dataset=...): # -> DatasetV2:
...
def sample_from_datasets_v1(datasets, weights=..., seed=..., stop_on_empty_dataset=...): # -> DatasetV1Adapter:
  ...
...
def choose_from_datasets_v2(datasets, choice_dataset, stop_on_empty_dataset=...): # -> DatasetV2:
...
def choose_from_datasets_v1(datasets, choice_dataset, stop_on_empty_dataset=...): # -> DatasetV1Adapter:
  ...
