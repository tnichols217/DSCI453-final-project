...
class FileIO:
  ...
  def seek(self, offset=..., whence=..., position=...): # -> None:
...
def read_file_to_string(filename, binary_mode=...): # -> bytes | str:
...
def write_string_to_file(filename, file_content): # -> None:
...
def get_matching_files(filename): # -> list[str]:
...
def get_matching_files_v2(pattern): # -> list[str]:
...
def recursive_create_dir(dirname): # -> None:
...
def recursive_create_dir_v2(path): # -> None:
  """Creates a directory and all parent/intermediate directories.
...
def copy_v2(src, dst, overwrite=...): # -> None:
...
def copy(oldpath, newpath, overwrite=...): # -> None:
  ...

@tf_export(v1=["gfile.Rename"])
def rename(oldname, newname, overwrite=...): # -> None:
...
def rename_v2(src, dst, overwrite=...): # -> None:
  """Rename or move a file / directory.
...
def delete_recursively(dirname): # -> None:
...
def delete_recursively_v2(path): # -> None:
...
def list_directory(dirname): # -> list[str]:
...
def list_directory_v2(path): # -> list[str]:
  """Returns a list of entries contained within a directory.
...
def walk(top, in_order=...): # -> Generator[tuple[str, list[Any], list[Any]] | Any, Any, None]:
...
def walk_v2(top, topdown=..., onerror=...): # -> Generator[tuple[str, list[Any], list[Any]] | Any, Any, None]:
  """Recursive directory tree generator for directories.
...
def stat(filename): # -> FileStatistics:
...
def stat_v2(path): # -> FileStatistics:
  """Returns file statistics for a given path.
...
def filecmp(filename_a, filename_b): # -> bool:
...
def file_crc32(filename, block_size=...): # -> str:
