...
def convert_graph_def(graph_def, pass_pipeline=..., show_debug_info=...): # -> str:
...
def convert_function(concrete_function, pass_pipeline=..., show_debug_info=...): # -> str:
...
def convert_saved_model(saved_model_path, exported_names, show_debug_info=...): # -> str:
...
def convert_saved_model_v1(saved_model_path, exported_names, tags, lift_variables, include_variables_in_initializers, upgrade_legacy=..., show_debug_info=...): # -> str:
...
def run_pass_pipeline(mlir_txt, pass_pipeline, show_debug_info=...): # -> str:
...
def tflite_to_tosa_bytecode(flatbuffer, bytecode, use_external_constant=..., ordered_input_arrays=..., ordered_output_arrays=...): # -> None:
