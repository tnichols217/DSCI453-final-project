...
_DENYLISTED_CATEGORICAL_COLUMNS_V2 = ...
_SUPPORTED_CATEGORICAL_COLUMNS = ...
_SEQUENCE_FEATURE_LENGTH_POSTFIX = ...
def embedding_column(categorical_column, dimension, combiner=..., initializer=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=...): # -> _TPUEmbeddingColumn:
...
def shared_embedding_columns(categorical_columns, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., max_sequence_lengths=..., learning_rate_fn=..., use_safe_embedding_lookup=...): # -> list[Any]:
...
class _TPUBaseEmbeddingColumn:
  ...
  def __init__(self, categorical_column, max_sequence_length=..., learning_rate_fn=...) -> None:
    ...
  ...
  def is_sequence_column(self): # -> bool:
    ...
  
  def get_max_sequence_length(self): # -> int:
    ...
  
  def get_learning_rate_fn(self): # -> None:
    ...
...
class _TPUEmbeddingColumn(_TPUBaseEmbeddingColumn, fc._EmbeddingColumn):
  ...
  def __new__(cls, categorical_column, dimension, combiner=..., layer_creator=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=..., bypass_scope_validation=...): # -> Self:
    ...
  
  def __init__(self, categorical_column, dimension, combiner=..., layer_creator=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=..., bypass_scope_validation=...) -> None:
    ...
...
class _TPUSharedEmbeddingColumn(_TPUBaseEmbeddingColumn, fc._SharedEmbeddingColumn):
  ...
  def __new__(cls, categorical_column, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=...): # -> Self:
    ...
  
  def __init__(self, categorical_column, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=...) -> None:
    ...
