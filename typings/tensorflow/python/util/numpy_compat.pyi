...
def np_array(values, dtype=..., copy=..., order=...):
...
def np_asarray(values, dtype=..., order=..., copy=...): # -> ndarray[_Shape, dtype[Any]]:
...
def np_where(condition, x=..., y=...): # -> tuple[NDArray[intp], ...] | NDArray[Any]:
...
def np_reshape(a, /, shape=..., *, newshape=..., order=..., copy=...):
