...
def is_nested_or_composite(seq): # -> bool:
...
def is_sequence_or_composite(seq): # -> bool:
  ...

@tf_export("nest.flatten")
def flatten(structure, expand_composites=...): # -> list[None] | object:
...
def assert_same_structure(nest1, nest2, check_types=..., expand_composites=...): # -> None:
...
def flatten_dict_items(dictionary): # -> object:
...
def pack_sequence_as(structure, flat_sequence, expand_composites=...): # -> defaultdict[Any, Any] | Any | list[Any] | None:
...
def map_structure(func, *structure, **kwargs): # -> defaultdict[Any, Any] | Any | list[Any] | object | None:
...
def map_structure_with_paths(func, *structure, **kwargs): # -> defaultdict[Any, Any] | Any | list[Any] | None:
...
def map_structure_with_tuple_paths(func, *structure, **kwargs): # -> defaultdict[Any, Any] | Any | list[Any] | None:
  """Applies `func` to each entry in `structure` and returns a new structure.
...
def assert_shallow_structure(shallow_tree, input_tree, check_types=..., expand_composites=...): # -> None:
...
def flatten_up_to(shallow_tree, input_tree, check_types=..., expand_composites=...): # -> list[Any]:
...
def flatten_with_tuple_paths_up_to(shallow_tree, input_tree, check_types=..., expand_composites=...): # -> list[tuple[Any, Any] | Any]:
  """Flattens `input_tree` up to `shallow_tree`.
...
def map_structure_up_to(shallow_tree, func, *inputs, **kwargs): # -> defaultdict[Any, Any] | Any | list[Any] | None:
...
def map_structure_with_tuple_paths_up_to(shallow_tree, func, *inputs, **kwargs): # -> defaultdict[Any, Any] | Any | list[Any] | None:
  """Applies a function or op to a number of partially flattened inputs.
...
def get_traverse_shallow_structure(traverse_fn, structure, expand_composites=...): # -> bool | defaultdict[Any, Any] | Any | list[Any] | None:
...
def yield_flat_paths(nest, expand_composites=...): # -> Generator[Any, Any, None]:
...
def flatten_with_joined_string_paths(structure, separator=..., expand_composites=...): # -> list[_T_co]:
...
def flatten_with_tuple_paths(structure, expand_composites=...): # -> list[_T_co]:
...
def list_to_tuple(structure): # -> defaultdict[Any, Any] | Any | list[Any] | None:
