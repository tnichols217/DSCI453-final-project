...
def set_optimizer_jit(enabled: Union[bool, str]): # -> None:
...
def get_device_policy(): # -> Literal['silent', 'silent_for_int32', 'warn', 'explicit']:
...
def get_visible_devices(device_type=...):
...
@tf_export('config.get_logical_device_configuration', 'config.experimental.get_virtual_device_configuration')
...
@tf_export('config.set_logical_device_configuration', 'config.experimental.set_virtual_device_configuration')
@deprecation.deprecated_endpoints('config.experimental.set_virtual_device_configuration')
...
def is_op_determinism_enabled(): # -> bool:
