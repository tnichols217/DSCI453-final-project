...
"""
def convert_to_eager_tensor(value, ctx, dtype=...) -> ops._EagerTensorBase:
...
def constant_v1(value, dtype=..., shape=..., name=..., verify_shape=...) -> Union[ops.Operation, ops._EagerTensorBase]:
...
def constant(value, dtype=..., shape=..., name=...) -> Union[ops.Operation, ops._EagerTensorBase]:
...
class _ConstantTensorCodec:
  ...
  def do_decode(self, value, decode_fn): # -> Operation | _EagerTensorBase:
...
class _NumpyCodec:
  ...
  def do_decode(self, value, decode_fn): # -> ndarray[tuple[()], dtype[float64]] | ndarray[tuple[()], dtype[Any]] | NDArray[float64] | ndarray[tuple[()], dtype[unsignedinteger[_16Bit]]] | ndarray[tuple[()], dtype[unsignedinteger[_8Bit]]]:
