...
class Supervisor:
  ...
  * Specifying `'grpc://hostname:port'` requests a session that uses
  ...
  def __init__(self, graph=..., ready_op=..., ready_for_local_init_op=..., is_chief=..., init_op=..., init_feed_dict=..., local_init_op=..., logdir=..., summary_op=..., saver=..., global_step=..., save_summaries_secs=..., save_model_secs=..., recovery_wait_secs=..., stop_grace_secs=..., checkpoint_basename=..., session_manager=..., summary_writer=..., init_fn=..., local_init_run_options=...) -> None:
    """Create a `Supervisor`.
  ...
  @property
  def init_op(self): # -> object | _dispatcher_for_no_op | Operation | int | None:
  ...
  @property
  def ready_op(self): # -> Operation | _EagerTensorBase | Any | int:
  ...
  @property
  def ready_for_local_init_op(self): # -> Any | int | None:
    ...
  
  @property
  def summary_writer(self): # -> FileWriter | int | None:
  ...
  @property
  def summary_op(self): # -> Operation | _EagerTensorBase | Any | int | None:
  ...
  @property
  def save_summaries_secs(self): # -> int | None:
  ...
  @property
  def global_step(self): # -> Tensor | Any | int | None:
  ...
  @property
  def saver(self): # -> Saver | Any | int | None:
  ...
  @property
  def save_model_secs(self): # -> int | None:
  ...
  def start_standard_services(self, sess): # -> list[Any] | None:
  ...
  def prepare_or_wait_for_session(self, master=..., config=..., wait_for_checkpoint=..., max_wait_secs=..., start_standard_services=...): # -> Session | None:
  ...
  def start_queue_runners(self, sess, queue_runners=...): # -> list[Any]:
  ...
  def loop(self, timer_interval_secs, target, args=..., kwargs=...): # -> LooperThread:
  ...
  def stop(self, threads=..., close_summary_writer=..., ignore_live_threads=...): # -> None:
  ...
  def stop_on_exception(self): # -> _GeneratorContextManager[None, None, None]:
  ...
  def managed_session(self, master=..., config=..., start_standard_services=..., close_summary_writer=...): # -> Generator[Session | Any | None, Any, None]:
